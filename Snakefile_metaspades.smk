configfile: 'config_metaspades.yaml'
...
# rule run_metaquast:
#     input:
#         contig_path="{wdir}/{sample}/metaspades",
#     output:
...
rule deepArg:
    ...
    run:
        ...
        #     -v {output.folder}:/deeparg_output/ \
        #     -v {input.deeparg_db}:/deepargDB/ \
        #     -v {input.prodigal_path}:/prodigal_input/ gaarangoa/deeparg:latest deeparg predict \
        #     --model LS \
        #     -i /prodigal_input/orf_predicted.faa \
        #     -o /deeparg_output/output \
        #     -d /deepargDB/ \
        #     --type prot \
        #     --min-prob 0.8 \
